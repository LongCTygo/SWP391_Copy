...
@WebFilter(urlPatterns = "/teacher/*", filterName = "TeacherOrHigherFilter",
description = "Allow only teachers or users with higher privileges to access pages with the above pattern.")
public class TeacherOrHigherFilter implements Filter {
    @Override
